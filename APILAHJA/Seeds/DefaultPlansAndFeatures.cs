...
//    {
//        var planRepository = scope.ServiceProvider.GetService<PlanBuilderRepository>();

//        //await context.PlanFeatures.ExecuteDeleteAsync();
//        //await context.Plans.ExecuteDeleteAsync();
//        //await context.SaveChangesAsync();
//        if (await planRepository.ExistsAsync(p => p.Id == "price_1Qn3ypKMQ7LabgRTSuyGIBVH")) return;
...
//                  {
//                        new PlanFeatureRequestBuildDto
//                        {
//                            Id = "number_models",
//                            Value = "3",
//                            Name = new Dictionary<string, string>
